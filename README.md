...
Due to privacy regulations, the complete human data from the two trials and cohorts are available only under restricted access. To allow verification of the analytical code used in this study, we uploaded a randomly selected subset of participants (20%). Consequently, results derived from this subset do not reflect the true results reported in the article.
